module lang::ptl::translations::translate2bigquery::TranslateDeclarations

extend lang::ptl::translations::translate2bigquery::TranslateViews;
...
public BigQuery toSQL(Program decl){
    switch(decl){
      case lang::ptl::ast::PTL::expression(e): return lang::bigquery::ast::BigQuery::expression(toSQL(e));
