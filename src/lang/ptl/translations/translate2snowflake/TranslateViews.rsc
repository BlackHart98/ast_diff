module lang::ptl::translations::translate2snowflake::TranslateViews

extend lang::ptl::translations::translate2snowflake::TranslateExpressions;
import List;
...
public QueryExpr toSQL(subViewDecl(
      ...
      return  querySnowflake(QuerySnowflake::query(
