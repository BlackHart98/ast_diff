module lang::basesql::prettyprint::SolutionModifiers

import lang::basesql::ast::BaseSQL;
import List;

extend lang::basesql::prettyprint::Expressions;
extend lang::basesql::prettyprint::Names;
...
// LimitClause
public str toString(LimitClause::limitClause(Expr expr)) = "LIMIT <toString(expr)>";

// OffsetClause
public str toString(OffsetClause::offsetClause(Expr expr)) = "OFFSET <toString(expr)>";