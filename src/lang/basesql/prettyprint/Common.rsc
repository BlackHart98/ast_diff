module lang::basesql::prettyprint::Common
...
extend lang::basesql::prettyprint::Expressions;
...
) = "DELIMITED <prettyOptional(fieldsTerminatedBy, toString)> <prettyOptional(collectionItemsTerminatedBy, toString)> <prettyOptional(mapKeysTerminatedBy, toString)> <prettyOptional(linesTerminatedByOpt, toString)> <prettyOptional(nullDefinedAs, toString)>";
