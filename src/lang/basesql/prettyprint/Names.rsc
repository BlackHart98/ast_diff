module lang::basesql::prettyprint::Names
extend lib::Utils;
...
// SchemaNameDot
public str toString(SchemaNameDot::schemaName(TableNameId id)) = "<toString(id)>.";


public str toString(TableNameId::tabId(Identifier id)) = "<toString(id)>";
