module lang::basesql::grammar::Common


extend lang::basesql::grammar::SolutionModifiers;
...
= delimited: 
    'DELIMITED' FieldsTerminatedBy? CollectionItemsTerminatedBy? MapKeysTerminatedBy? LinesTerminatedBy?
    NullDefinedAs?
